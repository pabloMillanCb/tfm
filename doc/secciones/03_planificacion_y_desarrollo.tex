...
Se realizó un prototipo. En total supuso \textbf{7 horas de trabajo efectivo}. A partir de este se decidió descartar el concepto del juego antes de realizar pruebas con otros usuarios. Esto se debió a lo siguiente:
...
\begin{itemize}
    ...
    \item \textbf{PZ-07 [DESTROY]}: El jugador se encontrará con unos bloques que bloquean una puerta. Estos solo podrán ser destruidos tras conseguir la habilidad que permite romper bloques.
    \item \textbf{PZ-08 [DESTROY, POGO]}: El jugador encuentra unos bloques destruibles en el suelo, de tal forma que no puede impactarlos con un golpe lateral. Tendrá que desbloquear la habilidad de rebotar con el arma para poder romperlos.
    \item \textbf{PZ-09 [DESTROY]}: El jugador encuentra una pila de bloques que deberá destruir de cierta manera para construir una escalera y alcanzar una plataforma a la que no podría haber accedido solo con sáltos.

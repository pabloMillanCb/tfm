...
\begin{table}[!ht]
    ...
    \hline
        ...
        OBJ-09 & El tamaño de la hitbox de los erizos rojos es demasiado grande, se activa sin dar la sensación de haber impactado & ~ \\ \hline
        OBJ-10 & El movimiento del jugador debe ser más lento y los valroes de la gravedad y la fuerza de salto deben ser ajustados. & ~ \\ \hline
...
En la tabla \ref{tab:sprint4task} se tienen las tareas realizadas durante el sprint. De las 20 horas estimadas se realizaron 19,5 efectivas. El sprint se realizó en el tiempo estimado y sin ningún impreviso o problema. Por lo tanto en esta ocasión no hay ningún punto a destacar para la dinámica de \textit{"qué ha ido bien, qué ha ido mal, qué haremos para adaptarnos"}. Se logró el objetivo de producir una sección jugable que aportó una visión más precisa del rumbo del proyecto a nivel lúdico.
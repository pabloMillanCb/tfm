...
\begin{table}[!ht]
    ...
    \hline
        ...
        SF-24 & Investigar opciones para el sistema de dialogo & 1 & 0,75 \\ \hline
        ...
        SF-27 & Implementar sistema de dialogo & 2,5 & 3,5 \\ \hline
        ~ & ~ & ~ & ~ \\ \hline
...
Y por tanto en los próximos sprints:
\begin{itemize}
    \item Se cambia el orden de realización de los sprints 3 y 4 con el objetivo de producir una \textit{vertical slice} para poder juzgar mejor el avance del proeycto a nivel lúdico.
...
\begin{table}[!ht]
    ...
    \hline
        ...
        ~ & ~ & ~ & ~ \\ \hline
        SF-33 & Implementar enemigo que recorre un camino aereo circular & 0,75 & 0,5 \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
        ...
        BUG-04 & Las componentes hurtbox de los enemigos reciben la señal de ataque al salir el area de hitbox, y no al entrar & 1,5 \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
        ...
        SF-42 & Implementar slider para ajuste de contrase y brillo en ajustes & 1 & 1 \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
        ...
        OBJ-10 & El movimiento del jugador debe ser más lento y los valroes de la gravedad y la fuerza de salto deben ser ajustados. & 0,5 \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
        ...
        BUG-10 & Al desbloquear una mejora y morir antes de volver a guardar, el juagdor spawnea con la mejora ya obtenida, interfiriendo con el avance natural del juego. & 0,25 \\ \hline
    \end{tabular}
...
La fase de postproducción consistió en un ciclo intensivo de pruebas con jugadores reales y ajustes al proyecto en función de la retroalimentación dada por los usuario y los \textit{bugs} que surgieran durante las partidas. Para ello se creó un \textit{backlog} de tareas adicional. Las tareas se dividen en los siguientes tipos:

\begin{itemize}
    \item \textit{PLAYTEST}: Representa el tiempo empleado monitorizando pruebas con usuarios.
    \item \textit{CI}: Tareas relacionadas con la integración continua del proeycto.
    \item \textit{BUG}: Errores de programación.
    \item \textit{OBJ}: Observaciones de juego. Son cambios en el diseño del juego motivados por la opinión de los jugadores y las observaciones eralizadas durante las pruebas.
\end{itemize}
...
\begin{table}[H]
    ...
    OBJ-38 & Acortar sala de guardado en zig-zag & Terminado & 0,1 \\ \hline
    \end{tabular}
    \caption{Lista de tareas realizadas en postproducción.}
    \label{tab:postpro2}
\end{table}
...
\begin{table}[H]
    ...
    OBJ-52 & TP derecha desde FISH golpea enemigo & Terminado & 0,1 \\ \hline
...
\begin{itemize}
    \item ¿Cuanto tardaste en completar el juego?
    \item ¿Qué porcentaje de compleción conseguiste?
    \item ¿Cuanta experiencia previa tienes jugando videojuegos? (1-5)
    \item ¿Cuanta experiancia previa tienes en juegos de exploración y/o metroidvanias? (1-5)
    \item ¿Cuanta experiencia previa tienes en juegos plataformas? (1-5)
    \item ¿Cuanto dirías que has disfrutado del juego?
...
En un proyecto comercial, esta fase del desarrollo tendría una mayor carga de desarrollo de material promocional y marketing. Como este es un trabajo académico, simplemente se produjo un trailer a modo de presentación del juego.

...
En este capítulo se describirá la metodología propuesta, formulada a partir de las conclusiones extraidas del capítulo \ref{chap:stateofart}. Posteriormente, se realizará una revisión de dicha metodología con la experiencia obtenida tras completar el desarrollo del juego, el cual se detalla en el capítulo \ref{chap:development}.
...
\begin{itemize}
    ...
    \item \textbf{Cambiar el enfoque de las iteraciones}. En lugar de iterar en sprints en los que se realizan versiones completas de cada elemento que compone juego, desarrollar versiones incompletas de muchos más elementos por iteración. Por ejemplo, en lugar de implementarn por completo el jugador en el primer sprint, implementar parte de el jugador y el funcionamiento básico de dos enemigos. Esto permitirá integrar playtesting en fases más tempranas de la producción.
...
\begin{enumerate}
    \item \textbf{Game Loop}: Se desarrolla un bucle jugable de principio a fin que se puede contrastar en playtesting.

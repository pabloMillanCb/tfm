...
Por último, se realizará una estimación del proyecto con un presupuesto en forma de horas efectivas de trabajo. El desarrollo completo hasta la salida del juego no deberá sobrepasar este número. Se puede observar un diagrama de esta fase de producción en la figura \ref{fig:preproduction}.
...
Se compila el juego y se prepara para su publicación por el medio correspondiente (Steam, \textit{itch.io}, consolas, etc.). También se preparan materiales promocionales como un tráiler y recursos gráficos. En la figura \ref{fig:deploy} se tiene un diagrama del despliegue.
